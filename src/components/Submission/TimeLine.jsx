        ...
        <div className="flex flex-col items-center relative z-20">
            <style jsx>{`
                ...
                @keyframes glowPulse {
                    ...
                    50% { box-shadow: 0 0 30px rgba(255, 215, 0, 1), 0 0 40px rgba(255, 215, 0, 0.6); }
                }
                .castle-bounce {
            ...
            {/* Castle/Checkpoint */}
            <div className={`relative ${isCurrent ? 'castle-bounce current-glow' : ''}`}>
                {/* Flag above castle */}
                <div className={`absolute -top-8 left-1/2 transform -translate-x-1/2 w-6 h-6 z-30 ${isCompleted || isCurrent ? 'flag-wave' : ''}`}>
                    <Image
                ...
                <div className="relative w-16 h-16 sm:w-20 sm:h-20">
                    <Image
                        src={isCompleted ? step.castle : "/castle_gray.png"}
                        alt={`${step.label} Castle`}
                        fill
                        className={`object-contain transition-all duration-500 ${isCompleted ? 'brightness-100' : 'brightness-50 grayscale'
                            }`}
                    />
            ...
            <div className="mt-4 text-center">
                {/* Main Label */}
                <div
                    className={`mario-text text-sm sm:text-base font-bold mb-1 ${isCompleted ? 'text-yellow-400' :
                ...
                {/* Sub Label */}
                <div
                    className={`text-xs sm:text-sm font-medium ${isCompleted ? 'text-white' :
            ...
            <style jsx>{`
                ...
                .mario-world-bg {
                    background: linear-gradient(180deg, 
                        #87CEEB 0%,   /* Sky blue */
                        #98D8E8 50%,  /* Light blue */
                        #90EE90 100%  /* Light green */
                    );
                }
            `}</style>

            <div className="mario-world-bg rounded-2xl p-6 border-4 border-black shadow-lg relative overflow-hidden">
                {/* Background Clouds */}
                ...
                <div className="relative w-full max-w-6xl mx-auto">
                    {/* Ground Line */}
                    <div
                        className="absolute bottom-12 left-0 w-full h-8 z-0 rounded"
                        style={{
                    ...
                    {/* Completed Path */}
                    <div
                        className="absolute bottom-12 left-0 h-8 z-10 rounded bg-gradient-to-r from-green-400 to-yellow-400 opacity-80 transition-all duration-1000"
                        style={{ width: pathCompletion }}
                    />

                    {/* Mario Character */}
                    <div
                        className="absolute bottom-16 z-30 transition-all duration-1000 mario-walk"
                        style={{ left: marioPosition, transform: 'translateX(-50%)' }}
                    >
                        <div className="relative w-8 h-8 sm:w-10 sm:h-10">
                            <Image
                                src={currentStep === steps.length ? "/char_mario_sm-jump.png" : "/char_mario_sm-idle.png"}
                                alt="Mario"
                                fill
                                className="object-contain"
                            />
                        ...
                        <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-white rounded-lg px-2 py-1 text-xs font-bold border-2 border-black whitespace-nowrap">
                    ...
                    {/* Timeline Steps */}
                    <div className="flex justify-between items-end relative z-20 pt-8">
                    ...
                    <div className="mt-8 text-center">
                        ...
                        >
                            <div className="w-4 h-4 mr-2">
                                <Image src="/item_coin.png" alt="Progress" fill className="object-contain" />
                            </div>
