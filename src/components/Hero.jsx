...
const HeroSection = () => {
  ...
  const endDate = new Date(2025, 7, 30, 23, 59, 59); // August 29, 2025 at 23:59:59
  ...
  return (
    <div
      ...
      <div
        ...
        <div
          ...
          <Image
            ...
            alt="Question Block"
            fill
            className={`object-contain hover:scale-110 transition-transform cursor-pointer ${leftBump ? 'block-bump' : ''
              }`}
          />
      ...
      <div
        ...
        <div
          className={`relative w-full h-full ${rightBump ? 'block-bump' : ''
            }`}
          role="button"
          ...
          {rightItem && (
            <span
              className={`item-sprite ${rightReturning ? 'item-return' : 'item-grow'
                }`}>
              <Image
                src={
                  rightItem.type === 'star'
