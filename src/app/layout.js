			...
			<head>
              ...
              'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
				...
				<meta
					...
					content="GitHub Community SRM - The Official student-led community affiliated with GitHub, spearheading the open-source revolution at SRMIST."
				/>
				<meta
					property="og:type"
					content="website"
				...
				<meta
					property="og:url"
					content="https://githubsrmist.tech"
				/>
				<link
					rel="canonical"
					href="https://githubsrmist.tech"
				/>
				<meta
					property="image"
					content="/favicon.ico"
				...
				<meta
					name="keywords"
					content="GitHub Community SRM recruitment, join GitHub SRM, open source recruitment SRMIST, SRMIST club recruitment, open source community, student developer recruitment, join open source SRM, GitHub SRMIST recruitment, SRMIST opportunities, tech club recruitment, developer community SRMIST"
				/>
				<meta
					name="author"
				...
				<meta
					name="twitter:title"
					content="GitHub Community SRM is Recruiting! | Join Us at SRMIST"
				/>
				<meta
				...
				<meta
					property="og:title"
					content="We're Recruiting! | GitHub Community SRM | Open Source at SRMIST"
				/>
				<meta
					property="og:description"
					content="Apply now to join GitHub Community SRM, the official student-led open-source community at SRM Institute of Science and Technology. Be part of our mission!"
				/>
				<meta
					property="og:url"
					content="https://githubsrmist.tech"
				...
				<script
					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							'description':
								'GitHub Community SRM is recruiting! Join the student-led open-source community at SRM Institute of Science and Technology. Apply now to be part of our next chapter.',
							'location': {
								'@type': 'Place',
