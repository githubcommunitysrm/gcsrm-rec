...
// End:   7th Sep 2025 12:00:00 IST
const SUBMISSION_START = new Date('2025-08-31T03:00:00+05:30');
const SUBMISSION_END = new Date('2025-09-07T12:00:00+05:30');
				...
				<div
					...
					<style jsx>{`
						...
						@keyframes powerUpGlow {
							...
							50% {
								box-shadow: 0 0 30px rgba(255, 230, 0, 1),
					...
					<div className="relative w-full max-w-md">
						...
						<div className="relative bg-gradient-to-b from-yellow-300 to-yellow-500 rounded-lg border-4 border-black shadow-2xl p-6 power-up-glow">
							...
							<h2
								...
								style={{
									fontFamily:
										'SuperMario256, Arial, sans-serif',
									textShadow:
										'2px 2px 0 #fff, 4px 4px 0 #ccc',
							...
							<div
								...
								{!error && (
									<div className="flex justify-center space-x-1">
										<span className="animate-[ping_1.5s_0.5s_ease-in-out_infinite] text-green-700 text-xl">
											.
										</span>
										<span className="animate-[ping_1.5s_0.7s_ease-in-out_infinite] text-green-700 text-xl">
											.
										</span>
										<span className="animate-[ping_1.5s_0.9s_ease-in-out_infinite] text-green-700 text-xl">
											.
										</span>
									</div>
								)}
						...
						{!error && (
							<div
								className="absolute -bottom-8 right-4 w-12 h-14 hidden sm:block mario-bounce"
								style={{ animationDelay: '0.5s' }}>
								<Image
									src="/item_mushroom.png"
									alt="Power-up"
									fill
			...
			{participantData ? (
				<div
					...
					<div
						...
						style={{
							backgroundImage:
								'url(/pattern-logos-characters.png)',
							backgroundRepeat: 'repeat',
					...
					<div
						className="absolute top-16 right-12 w-28 h-18 opacity-70 animate-pulse"
						style={{ animationDelay: '1s' }}>
						<Image
							src="/cloud-2.png"
							alt="Cloud"
					...
					<div
						className="absolute top-40 left-16 w-12 h-12 hidden lg:block animate-bounce"
						style={{ animationDelay: '1s' }}>
						<Image
					...
					<div className="relative z-20 flex flex-col items-center justify-center text-white p-4 sm:p-6 pt-8">
						...
						<div
							className="relative bg-gradient-to-b from-yellow-300 to-yellow-500 rounded-lg border-4 border-black shadow-2xl p-6 mb-6 max-w-2xl mx-auto"
							style={{
								boxShadow:
									'0 0 20px rgba(255, 230, 0, 0.8), inset 0 4px 8px rgba(255, 255, 255, 0.3)',
							}}>
						...
						{participantData.tasks.length > 0 && (
							<div className="flex flex-row sm:flex-row justify-center my-6 z-40">
								<div className="flex flex-wrap justify-center gap-4">
									{getTaskTypes(participantData.tasks).map(
										(type) => (
											<button
												key={type}
						...
						<div className="relative mb-8 z-50 pb-12">
							...
							<div
								className="absolute -top-8 -right-8 w-12 h-12 animate-bounce"
								style={{ animationDelay: '0.5s' }}>
								<Image
									src="/item_mushroom.png"
									alt="Mushroom"
						...
						<div
							className="absolute top-80 right-16 w-8 h-8 hidden md:block"
							style={{ animationDelay: '1s' }}>
							<Image
								src="/coin.png"
								alt="Coin"
